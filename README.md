...
3. Сделать видимыми внтренности кузова, чтобы за колёсами не было просветов
4. Тщательно подогнать колёса к кузову в фотошопе (а не в Unity)
5. Найти дизайнера-художника
...
1. Сдлеать пушку
2. Ускорить машину
3. Доделать распространение частиц из под колёс
