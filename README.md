...
4. Если при `git pull` были конфликты (в консоли будет написано CONFLICT: имя файла) то нужно вручную отредактировать эти файлы (зайти в них, найти строку с символами: "<<<<<<< HEAD". Всё что после них и до "=====" это из удалённой репы, а всё что после "=====" и до ">>>>>" это ваши изменения, нужно удалить эти закорючки ("<<<<<<< HEAD" и пр.) и оставить только нужные строки. *Только внимательнее - лишнего не удалите*) и потом ввести команду `git merge origin`
