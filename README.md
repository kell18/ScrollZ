...
#####По графике:
1. __Задизайнить первый уровень__
2. __Доделать мертвяка №1 (сделать анимацию смерти, улучшить хотьбу и убрать большие рамки)__
3. __Найти хорошие звуки для игры__
4. Сделать видимыми внтренности кузова, чтобы за колёсами не было просветов
5. Тщательно подогнать колёса к кузову в фотошопе (а не в Unity)
6. Найти дизайнера-художника

> 
+ Сделать один качественный спрайт зомбака и отдельно картинки его конечностей **Сделано**

#####По механике:
1. Сделать звуки двигателя и окружения
2. Сдлеать пушку
3. Ускорить машину
4. Доделать распространение частиц из под колёс
	
>
+ Определить силу и направление столкновения **Сделано**
+ Сделать разлёт частей **Сделано**
+ Добавить машине способность вращаться в воздухе **Сделано**
